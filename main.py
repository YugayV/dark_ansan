...
Версия 2.1 - Автоматическая отправка фото адреса и уведомления
"""
...
def check_single_instance():
    ...
    try:
        ...
        logger.error("💡 Выполните: sudo pkill -f python")
        sys.exit(1)
...
if __name__ == "__main__":
    # Остановить все предыдущие процессы перед запуском
    import subprocess
